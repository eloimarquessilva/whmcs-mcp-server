...
export const ERROR_GUIDANCE: Record<string, string> = {
  ...
  'duplicate email': 'A client with this email already exists. Use search_clients to find them, or set mode to "reuse_if_exists".',
  'invalid email': 'The email format is invalid. Ensure it follows the format: user@domain.com',
  
  // Invoice-related errors
  'invoice not found': 'The invoice ID does not exist. Check the client\'s invoice list with get_invoice.',
  'invoice already paid': 'This invoice has already been paid. Check the current status before attempting payment.',
  'invalid invoice status': 'The operation cannot be performed on an invoice with this status.',
  
  // Payment-related errors
  'payment declined': 'The payment gateway rejected the transaction. Check card details or try a different payment method.',
  'gateway error': 'The payment gateway returned an error. This may be a temporary issue - try again later.',
  'insufficient funds': 'The payment was declined due to insufficient funds on the payment method.',
  
  // Service-related errors
  'service not found': 'The service ID does not exist. Use the client\'s product list to find valid service IDs.',
  ...
  'service already terminated': 'The service has already been terminated. This action cannot be undone.',
  ...
  'tld not configured': 'This TLD is not configured for registration. Check WHMCS domain pricing settings.',
  
  // Permission-related errors
  'access denied': 'API credentials lack permission for this action. Check WHMCS Setup → Staff Management → API Roles.',
  'authentication failed': 'API authentication failed. Verify WHMCS_IDENTIFIER and WHMCS_SECRET are correct.',
  'ip not allowed': 'Your server IP is not in the WHMCS API whitelist. Add it in Setup → General Settings → Security.',
  
  // Rate limiting
  'rate limit exceeded': 'Too many requests in a short time. Wait 10-30 seconds before retrying.',
  
  // Mode restrictions
  'read_only mode': 'This operation is not allowed in read_only mode. Change MCP_MODE to "simulate" or "full".',
